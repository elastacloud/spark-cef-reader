...
import CefRecordParser.replaceLineCharsForNull
      ...
      case e: CefRecordParserException =>
        ...
        e.partialData match {
          case Some(data) =>
            ...
            throw CefBadRecordException(() => recordString, () => Some(resultRow), e)
          case None => throw CefBadRecordException(() => recordString, () => None, e)
        }
    }
  }
